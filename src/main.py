...
from src.models.user import db, User, Client, Website, Keyword, KeywordRanking, GA4DataCache, GA4Account, GA4Property
...
from src.routes.ga4 import ga4_bp
...
def create_app():
    ...
    app.register_blueprint(ga4_bp, url_prefix='/api/ga4')
